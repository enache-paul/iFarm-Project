...
class MarsH2RepositoryExceptionsTest {
    ...
    void functionsWithSQLExceptionFailsNicely() {
        ...
        // Act + Assert
        Assertions.assertThrows(RepositoryException.class, () -> repo.getPlant(id));
        Assertions.assertThrows(RepositoryException.class, () -> repo.updateGardenTier(id, Constants.Tier.FREE));
    }
